...
ggplot(x, aes(x = group, y = TP_Inflow_mg_L, fill = group )) +
  geom_boxplot(position = position_dodge2(preserve = "single"), outlier.alpha = 1) +
  scale_y_continuous(trans='log10')
  

ggplot(x, aes(x = group, y = SRP_Inflow_mg_L, fill = group )) +
  geom_boxplot(position = position_dodge2(preserve = "single"), outlier.alpha = 1) +
  scale_y_continuous(trans='log10')

ggplot(x, aes(x = group, y = TP_load_in_g_m2_yr, fill = group )) +
  geom_boxplot(position = position_dodge2(preserve = "single"), outlier.alpha = 1) +
  scale_y_continuous(trans='log10')


ggplot(x, aes(x = group, y = SRP_load_in_g_m2_yr, fill = group )) +
  geom_boxplot(position = position_dodge2(preserve = "single"), outlier.alpha = 1) +
  scale_y_continuous(trans='log10')
...
pwc <- x %>%
  pairwise_t_test(TP_Inflow_mg_L ~  group, p.adjust.method = 'bonferroni')
pwc
